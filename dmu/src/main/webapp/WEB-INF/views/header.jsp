	...
	<div id="app">
					...
					<div class="main-menu-area">
						...
						<div class="main-menu">
							<ul>
								...
								<li class=""><a href="javascript:void(0);"> TICKET </a>
							</ul>
            ...
            <div class="header-logo-area">
				...
				<h1>
					<a href="/" aria-current="page"
						class="router-link-exact-active router-link-active"> 대림문화재단 </a>
				</h1>
		...
		<div class="main-menu-area">
			<div class="menu-header">
				<strong class="logo"> <a href="/" aria-current="page"
					class="router-link-exact-active router-link-active"> 대림문화재단 </a>
				</strong>
			</div>
			<div class="main-menu">
