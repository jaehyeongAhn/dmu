			...
			<div data-v-ec5a0c2c="" class="body-wrapper">
				<div data-v-25f87e60="" data-v-ec5a0c2c="">
					<div data-v-25f87e60="" class="sub-contents-area">
						...
						<!---------------------------------------------->
						<div class="content">
							<form name="ticketlistform" action="ticketlist_write_check.do"
										...
										<div data-v-8ed31374="" class="left">
											...
											<div data-v-8ed31374="" class="info-ticket">
												...
												<div style="margin-bottom: 20px;">
													<strong style="color: red;">*</strong>는 필수사항입니다.
												</div>
												<ul data-v-8ed31374="">
													<li data-v-8ed31374=""><strong data-v-8ed31374=""
														class="title">코드</strong> <select data-v-8ed31374=""
														name="dcode" id="dcode">
													...
													<li data-v-8ed31374=""><strong data-v-8ed31374=""
														class="title">회차/수업시간</strong> <span data-v-8ed31374=""
													...
													<li data-v-8ed31374="" class=""><strong
														...
														data-v-8ed31374="" class="text"><input type="text"
															name="dpersonnel" id="dpersonnel"></span></li>

													<li data-v-8ed31374="" class=""><strong
														data-v-8ed31374="" class="title">대상</strong> <select
														data-v-8ed31374="" name="dtarget" id="dtarget">
															<option value="default">선택하세요</option>
													...
													<li data-v-8ed31374="" class=""><strong
														...
														data-v-8ed31374="" class="text"><input type="text"
															name="dnum" id="dnum"></span></li>
													<li data-v-8ed31374=""><strong data-v-8ed31374=""
														class="title">운영시간/교육시간</strong> <textarea name="dtime"></textarea>
													</li>
												</ul>
											</div>
