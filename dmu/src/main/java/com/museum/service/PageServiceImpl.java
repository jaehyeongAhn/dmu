	 ...
	 public Map<String,Integer> getPageResult(String rpage,String serviceName, Object service) {
		...
		//startCount, endCount
			...
			if(serviceName.equals("learn")) {
				ticketService =(TicketServiceImpl)service;
				 dbCount = ticketService.getTicketCount(serviceName);
			...
			else if(serviceName.equals("exhibition")) {
				ticketService =(TicketServiceImpl)service;
				dbCount = ticketService.getTicketCount(serviceName);
				...
				ticketService =(TicketServiceImpl)service;
				dbCount =ticketService.getTicketLearnCount(serviceName); 
			}
